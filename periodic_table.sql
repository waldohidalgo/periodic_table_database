...
--
-- Name: properties fkey_properties_type_id; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fkey_properties_type_id FOREIGN KEY (type_id) REFERENCES public.types(type_id);
